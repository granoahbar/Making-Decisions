...
{
  console.log ("Amy & Brittani were born in the same yaer")
}
else 
{
...
{
  console.log ("one should wear a t-shirt and shorts, but also carry a light jacket just in case the temp is closer to 60")
}
